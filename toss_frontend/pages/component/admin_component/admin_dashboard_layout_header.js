...
export default function AdminDashboardLayoutHeader(props) {
...
<nav className={headerstyles.header_right}>
  ...
  <FontAwesomeIcon icon={faShieldHalved} className={headerstyles.lebel2} />Admin
  </span>
  ...
  <ul className="flex flex-col font-medium p-2 md:p-0 mt-0 md:flex-row md:space-x-4">
     <li>
      ...
      <Image width="150" height="150" className={headerstyles.profile} src={"http:/localhost:3000/admin/getimage/"+props.ProfilePicture}
...
>
    <div className="p-3">
        <div className="flex items-center justify-between mb-2">
                ...
                <Image 
                 width="50" height="50" className={headerstyles.profile}
                  src={"http:/localhost:3000/admin/getimage/"+props.userdata.ProfilePicture}
       ...
       >
        ...
        >Admin at <a href="/" className="text-blue-600 dark:text-blue-500 hover:underline">Traffic Operation & Surveillance System</a>.</p>
