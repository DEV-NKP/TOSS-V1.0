...
import {faAngleDown, faArrowRight, faCarBurst, faCarOn, faHourglassStart, faPenNib, faReply, faSackDollar, faShieldHalved, faSitemap, faTriangleExclamation, faUser, faUserTag} from '@fortawesome/free-solid-svg-icons'
...
export default function OwnerDashboardLayoutMenu(props) {
...
>
      ...
      <li>
        <Link href={"/owner/profile/owner_viewprofile?Uname="+props.Uname} >
        <div className={[`flex items-center p-3 pl-2 ml-3`, 
         ...
         <li>
         <Link href={"/owner/apply_vli/owner_applyvli?Uname="+props.Uname}>
         <div  className={[`flex items-center p-3 pl-2 ml-3`, 
           menustyles.menu_lebel].join(' ')}>
         <FontAwesomeIcon icon={faPenNib} className="flex-shrink-0 w-6 h-6"/>
         <span className="flex-1 ml-3 whitespace-nowrap">Apply Vli</span>
         </div>
        </Link>
       
         </li>
         <li>
         <Link href={"/owner/cases/owner_viewpendingcase?Uname="+props.Uname}>
         <div  className={[`flex items-center p-3 pl-2 ml-3`, 
           menustyles.menu_lebel].join(' ')}>
         <FontAwesomeIcon icon={faCarOn} className="flex-shrink-0 w-6 h-6"/>
         ...
         <li>
         <Link href={"/owner/cases/owner_viewpreviouscase?Uname="+props.Uname}>
         <div  className={[`pl-6 w-18 h-10 items-center pt-2 pb-5`, 
         ...
         <li>
         <Link href={"/owner/view_all/owner_viewallowner?Uname="+props.Uname} >
         <div className={[`flex items-center p-3 pl-2 ml-3`, 
           menustyles.menu_lebel].join(' ')}>
         ...
         <li>
         <Link href={"/owner/view_all/owner_viewallofficer?Uname="+props.Uname}>
         <div  className={[`pl-6 w-18 h-10 items-center pt-2 pb-5`, 
         ...
         <li>
         <Link href={"/owner/view_all/owner_viewallcops?Uname="+props.Uname}>
         <div  className={[`pl-6 w-18 h-10 items-center pt-2 pb-5`, 
         ...
         <li>
         <Link href={"/owner/bank/owner_account?Uname="+props.Uname}>
         <div  className={[`flex items-center p-3 pl-2 ml-3`, 
           menustyles.menu_lebel].join(' ')}>
         ...
         <Link href={"/owner/bank/owner_account?Uname="+props.Uname}>
         <div  className={[`pl-6 w-18 h-10 items-center pt-2 pb-5`, 
           menustyles.sub_menu_lebel].join(' ')}>My Account
           </div>
        </Link>
         ...
         <li>
         <Link href={"/owner/report/owner_addreport?Uname="+props.Uname}>
         <div  className={[`flex items-center p-3 pl-2 ml-3`, 
           menustyles.menu_lebel].join(' ')}>
         ...
         <li>
         <Link href={"/owner/history/owner_viewloginhistory?Uname="+props.Uname}>
         <div  className={[`flex items-center p-3 pl-2 ml-3`, 
           menustyles.menu_lebel].join(' ')}>
         ...
         <li>
         <Link href={"/owner/history/owner_viewlogouthistory?Uname="+props.Uname} >
         <div className={[`pl-6 w-18 h-10 items-center pt-2 pb-5`, 
