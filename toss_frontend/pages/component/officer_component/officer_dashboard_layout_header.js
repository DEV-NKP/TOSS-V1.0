...
import {faAngleDown, faArrowRight, faEnvelope, faHourglassStart, faPhone, faReply, faRightFromBracket, faShieldHalved, faSitemap, faTriangleExclamation, faUser, faUserTag} from '@fortawesome/free-solid-svg-icons'


export default function OfficerDashboardLayoutHeader(props) {
...
<nav className={headerstyles.header_right}>
  ...
  <FontAwesomeIcon icon={faShieldHalved} className={headerstyles.lebel2} />Officer
  </span>
...
>
    <div className="p-3">
       ...
       >
        ...
        >Officer at <a href="/" className="text-blue-600 dark:text-blue-500 hover:underline">Traffic Operation & Surveillance System</a>.</p>
