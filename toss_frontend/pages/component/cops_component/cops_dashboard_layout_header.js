...
import {faAngleDown, faArrowRight, faEnvelope, faHourglassStart, faPhone, faReply, faRightFromBracket, faShieldHalved, faSitemap, faTriangleExclamation, faUser, faUserNurse, faUserTag} from '@fortawesome/free-solid-svg-icons'


export default function CopsDashboardLayoutHeader(props) {
...
<nav className={headerstyles.header_right}>
  ...
  <FontAwesomeIcon icon={faUserNurse} className={headerstyles.lebel2} />Cops
  </span>
  ...
  <li>
      ...
      <Image width="150" height="150" className={headerstyles.profile} src={"http:/localhost:3000/officer/getimage/"+props.ProfilePicture}
...
>
    <div className="p-3">
        <div className="flex items-center justify-between mb-2">
                ...
                <Image 
                 width="50" height="50" className={headerstyles.profile}
                  src={"http:/localhost:3000/officer/getimage/"+props.userdata.ProfilePicture}
       ...
       >
        ...
        >Cops at <a href="/" className="text-blue-600 dark:text-blue-500 hover:underline">Traffic Operation & Surveillance System</a>.</p>
