...
import viewalllogins_tablestyle from '../../../styles/shared_style/toss_table_style.module.css'
...
<DashboardLayoutHeader Title="All Login Informations" userdata={data} Uname={data.Uname} ProfilePicture={data.ProfilePicture}></DashboardLayoutHeader>

    <div className={[`relative overflow-x-auto shadow-md sm:rounded-lg`, 
    viewalllogins_tablestyle.toss_table_full_container_div].join(' ')}>
<div className={[`grid grid-cols-1 gap-3 p-10 pr-4 sm:grid-cols-1`, 
    viewalllogins_tablestyle.toss_table_full_search_div].join(' ')}>

        {/* <label htmlFor="table-search" className="sr-only">Search</label> 
        whitespace-nowrap*/}

        <div className={[`pl-5 pr-5`, 
         viewalllogins_tablestyle.toss_table_search].join(' ')}>
    ...
    viewalllogins_tablestyle.toss_table_full].join(' ')}>
        <thead className={[`text-xs text-gray-700 dark:text-gray-400`, 
    viewalllogins_tablestyle.toss_table_head].join(' ')}>
            <tr>
        ...
        <tbody>
            ...
            viewalllogins_tablestyle.toss_table_data].join(' ')}>
                ...
                <td className="px-6 py-4">
                <Link href={"/cops/all/login_history/view/"+item.LogInId+"?Uname="+data.Uname} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">View History</Link>
                </td>
            </tr>
            ))}
        </tbody>
...
var viewdata="";
const response_viewalllogs = await api.get('/cops/findloginbysignup/'+tossSession.Uname)
