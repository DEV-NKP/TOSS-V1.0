...
export default function ViewAllTransaction({data, transactiondata}) {
...
{/* ------------------   Header   --------------- */}
  ...
  <OfficerDashboardLayoutHeader  Title="Transaction Details" userdata={data}  Uname={data.Uname} ProfilePicture={data.ProfilePicture}></OfficerDashboardLayoutHeader>
...
var data="";
const response_admin = await api.get('/officer/viewprofile/'+tossSession.Uname)
.then(response_admin => {
  // handle the response
