...
import ownerpagestyles from '../../../../../styles/officer_style/officer_viewprofile_style.module.css'
...
{/* ------------------   Header   --------------- */}
  ...
  <OfficerDashboardLayoutHeader Title="Owner Details"  userdata={data} Uname={data.Uname} ProfilePicture={data.ProfilePicture}></OfficerDashboardLayoutHeader>
...
.then(response_officer => {
  ...
  const response = await api.get('/officer/viewownerbyuname/'+ownerUname);
