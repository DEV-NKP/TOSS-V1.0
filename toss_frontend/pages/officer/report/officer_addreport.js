...
import { faPaperPlane, faVoicemail, faEnvelopeOpen, faComment, faComments, faTicket} from '@fortawesome/free-solid-svg-icons'
...
export default function Report({data}) {
    ...
    const onSubmit = async (submitdata) => {
        ...
        try {
            const response = await api.post("/officer/report/"+data.Uname,
            { 
              ...
              console.log(response);
                ...
                setSuccess("Thank you for submitting report. Our tema will check the details and take action aginst it.");
                reset();
