...
<DashboardLayoutHeader Title="Log In History"  userdata={data} Uname={data.Uname} ProfilePicture={data.ProfilePicture}></DashboardLayoutHeader>
    ...
    viewalllogins_tablestyle.toss_table_full].join(' ')}>
        ...
        <tbody>
            ...
            viewalllogins_tablestyle.toss_table_data].join(' ')}>
                ...
                <td className="px-6 py-4">
                <Link href={"/owner/all/login_history/view/"+item.LogInId+"?Uname="+data.Uname} className="font-medium text-teal-300 dark:text-blue-500 hover:underline">View Details</Link>
                </td>
            </tr>
            ))}
        </tbody>
...
var viewdata="";
const response_viewallofficer = await api.get('/owner/findloginbysignup/'+tossSession.Uname)
