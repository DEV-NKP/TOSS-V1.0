...
export default function ViewAllOfficerByOwner({data, officerdata}) {
...
{/* ------------------   Header   --------------- */}
  ...
  <OwnerDashboardLayoutHeader Title="Officer Details" userdata={data}  Uname={data.Uname} ProfilePicture={data.ProfilePicture}></OwnerDashboardLayoutHeader>
...
.then(response_officer => {
  ...
  const response = await api.get('/owner/viewofficerbyuname/'+officerUname);
