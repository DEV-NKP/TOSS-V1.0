...
export default function OwnerViewPreviousCase({data, viewdata}) {
  return (
    <>
    <div className="sm:ml-64">

<DashboardLayoutHeader  Title="All Previous Cases" userdata={data} Uname={data.Uname} ProfilePicture={data.ProfilePicture}></DashboardLayoutHeader>
...
const response_viewallowner = await api.get('/owner/viewpreviouscase/'+tossSession.Uname)
